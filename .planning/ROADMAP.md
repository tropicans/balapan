...
- [ ] **Phase 3: Race Director 3-Column Ergonomics & BTO Shimmer** - Reorganisasi layout input waktu RD menjadi 3-kolom horizontal sejajar lintasan + pendar animasi emas BTO #1.
...
Plans:
- [ ] 03-01: Implementasi layout 3-kolom finish time di RD Dashboard & border shimmer BTO emas di TV/Mobile
...
|-------|----------------|--------|-----------|
| 3. RD 3-Column Ergonomics & BTO Shimmer | 0/1 | Not started | - |
