      ...
      <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-[10px] font-mono text-cyberSilver/60">
          ...
          {screens.map(s => {
            ...
            return (
              <button
                ...
                className={clsx(
                  "flex items-center gap-1.5 px-3 py-1.5 text-xs font-orbitron font-semibold uppercase tracking-wider transition-all duration-150 clip-cyber border",
                  isActive
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-midnight border border-neonCyan/40 clip-cyber hover:border-neonCyan text-left"
          >
        ...
        {screens.map(s => {
          ...
          return (
            <button
              ...
              onClick={() => setActiveScreen(s.id)}
              className={clsx(
                "flex items-center gap-1 px-2.5 py-1 text-[11px] font-orbitron uppercase whitespace-nowrap clip-cyber border",
                isActive
